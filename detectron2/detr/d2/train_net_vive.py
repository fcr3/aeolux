...
from eval_hook import LossEvalHook
from test_hook import VinbigdataEvaluator
# from augments import AlbumentationsMapper
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        This uses the special metadata "evaluator_type" associated with each builtin 
        dataset.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        return build_detection_test_loader(
            cfg, dataset_name, mapper=DetrDatasetMapper(cfg, True)
        )
